...
MACRO_CONFIG_STR(SvGametype, sv_gametype, 128, "M-RPG Cross", CFGFLAG_SAVE|CFGFLAG_SERVER, "Server gametype")
...
MACRO_CONFIG_STR(SvMap, sv_map, 128, "M-RPG", CFGFLAG_SAVE|CFGFLAG_SERVER, "Map to use on the server")
